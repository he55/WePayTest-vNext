...
@class PreEnterWechatLogic, MainTabBarViewController, MMMainViewController, MMSplitViewController, SplitViewEmptyViewController, NewMainFrameViewController;
